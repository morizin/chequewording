text={1:"One ",2:"Two ",3:"Three ",4:"Four ",5:"Five ",6:"Six ",7:"Seven ",8:"Eight ",9:"Nine ",10:"Ten ",
	...
	90: 'Ninty ',91:'Ninety One ',92:'Ninety Two ',93: 'Ninety Three ',94: 'Ninety Four ',95:'Ninety Five ',96: 'Ninety Six ',97:'Ninety Seven ',98:'Ninety Eight',99:'Ninety Nine ',
	100:"Hundred ",1000:'Thousand ',100000:'Lack ',10000000:'Crore ',}

power=[10000000,100000,1000,100,10,1]
def main(num):
	finallist=[]
	num1=num
	numsub=0
	for x in power:
		...
		if num2 != 0:
			...
			if x == 1:
				...
				finallist.append(num3)
			else:
				finallist.append(num2)	
				finallist.append(num4)
		else:
			continue
	return finallist
def ToWord(num,currency):
	strnum=''
	et2=main(num)
	var =et2[0]
	lenght=len(str(var))
	...
	lst=newlist
	for i in lst:
		strnum=strnum+str(text.get(i))
	return strnum+currency.title()+' Only'
num = int(input('Enter your MONEY:  '))
currency=input('Enter Currency:  ')
print(ToWord(num,currency)) 